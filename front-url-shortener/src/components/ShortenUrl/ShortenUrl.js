...
const ShortenUrl = () => {
  ...
  return(
    <div className="shorten-url">
      ...
      {showWarning && <p style={{color: "red", textAlign: "center"}}>Veuillez remplir le champ.</p>}
      ...
      {isLinkSent && (
        <div className="shorten-url__success">
          ...
          <p><span>URL raccourcie</span> : <a href={customLink} target="_blank" rel="noreferrer">{customLink}</a> </p>
        </div>
      )}
    </div>
  )
